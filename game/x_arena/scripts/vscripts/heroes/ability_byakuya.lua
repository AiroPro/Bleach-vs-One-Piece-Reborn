...
function ExorcismDeath( event )
	...
	if caster:FindAbilityByName("bvo_byakuya_skill_1"):IsHidden() then
		local sync1 = caster:FindAbilityByName("bvo_byakuya_skill_1_off"):GetCooldownTimeRemaining()
		local sync4 = caster:FindAbilityByName("bvo_byakuya_skill_4_off"):GetCooldownTimeRemaining()

		local level2 = caster:FindAbilityByName("bvo_byakuya_skill_1_off"):GetLevel()
		caster:SwapAbilities("bvo_byakuya_skill_1", "bvo_byakuya_skill_1_off", true, true)
		caster:FindAbilityByName("bvo_byakuya_skill_1"):SetLevel(level2)
		caster:FindAbilityByName("bvo_byakuya_skill_1_off"):SetHidden(true)

		local level3 = caster:FindAbilityByName("bvo_byakuya_skill_4_off"):GetLevel()
		caster:SwapAbilities("bvo_byakuya_skill_4", "bvo_byakuya_skill_4_off", true, true)
		caster:FindAbilityByName("bvo_byakuya_skill_4"):SetLevel(level3)
		caster:FindAbilityByName("bvo_byakuya_skill_4_off"):SetHidden(true)

		caster:FindAbilityByName("bvo_byakuya_skill_1"):StartCooldown(sync1)
		caster:FindAbilityByName("bvo_byakuya_skill_4"):StartCooldown(sync4)
	else
		local sync1 = caster:FindAbilityByName("bvo_byakuya_skill_1"):GetCooldownTimeRemaining()
		local sync4 = caster:FindAbilityByName("bvo_byakuya_skill_4"):GetCooldownTimeRemaining()

		local level2 = caster:FindAbilityByName("bvo_byakuya_skill_1"):GetLevel()
		caster:SwapAbilities("bvo_byakuya_skill_1", "bvo_byakuya_skill_1_off", true, true)
		caster:FindAbilityByName("bvo_byakuya_skill_1_off"):SetLevel(level2)
		caster:FindAbilityByName("bvo_byakuya_skill_1"):SetHidden(true)

		local level3 = caster:FindAbilityByName("bvo_byakuya_skill_4"):GetLevel()
		caster:SwapAbilities("bvo_byakuya_skill_4", "bvo_byakuya_skill_4_off", true, true)
		caster:FindAbilityByName("bvo_byakuya_skill_4_off"):SetLevel(level3)
		caster:FindAbilityByName("bvo_byakuya_skill_4"):SetHidden(true)

		caster:FindAbilityByName("bvo_byakuya_skill_1_off"):StartCooldown(sync1)
		caster:FindAbilityByName("bvo_byakuya_skill_4_off"):StartCooldown(sync4)
	end
end
