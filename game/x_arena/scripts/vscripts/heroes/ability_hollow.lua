...
function bvo_hollow_skill_3(keys)
	...
	local sync1 = caster:FindAbilityByName("bvo_hollow_skill_1"):GetCooldownTimeRemaining()

	local level = caster:FindAbilityByName("bvo_hollow_skill_5_off"):GetLevel()
	caster:FindAbilityByName("bvo_hollow_skill_5"):SetLevel(level)
	caster:SwapAbilities("bvo_hollow_skill_5", "bvo_hollow_skill_5_off", true, true)
	caster:FindAbilityByName("bvo_hollow_skill_5_off"):SetHidden(true)

	local level2 = caster:FindAbilityByName("bvo_hollow_skill_1"):GetLevel()
	caster:FindAbilityByName("bvo_hollow_skill_1_bankai"):SetLevel(level2)
	caster:SwapAbilities("bvo_hollow_skill_1", "bvo_hollow_skill_1_bankai", true, true)
	caster:FindAbilityByName("bvo_hollow_skill_1"):SetHidden(true)
	...
	caster:FindAbilityByName("bvo_hollow_skill_1_bankai"):StartCooldown(sync1)
end
...
function bvo_hollow_skill_3_end(keys)
	...
	local sync1 = caster:FindAbilityByName("bvo_hollow_skill_1_bankai"):GetCooldownTimeRemaining()
	local off_sync1 = caster:FindAbilityByName("bvo_hollow_skill_5"):GetCooldownTimeRemaining()

	local level = caster:FindAbilityByName("bvo_hollow_skill_5"):GetLevel()
	caster:FindAbilityByName("bvo_hollow_skill_5_off"):SetLevel(level)
	caster:SwapAbilities("bvo_hollow_skill_5", "bvo_hollow_skill_5_off", true, true)
	caster:FindAbilityByName("bvo_hollow_skill_5"):SetHidden(true)

	local level2 = caster:FindAbilityByName("bvo_hollow_skill_1_bankai"):GetLevel()
	caster:FindAbilityByName("bvo_hollow_skill_1"):SetLevel(level2)
	caster:SwapAbilities("bvo_hollow_skill_1", "bvo_hollow_skill_1_bankai", true, true)
	caster:FindAbilityByName("bvo_hollow_skill_1_bankai"):SetHidden(true)

	caster:SetModel("models/hero_hollow/hero_hollow_base.vmdl")
	caster:SetOriginalModel("models/hero_hollow/hero_hollow_base.vmdl")

	caster:FindAbilityByName("bvo_hollow_skill_5_off"):StartCooldown(off_sync1)
	caster:FindAbilityByName("bvo_hollow_skill_1"):StartCooldown(sync1)
