...
function ichigo_skill_3(keys)
	...
	local level2 = caster:FindAbilityByName("bvo_ichigo_skill_4_off"):GetLevel()
	caster:SwapAbilities("bvo_ichigo_skill_4", "bvo_ichigo_skill_4_off", true, true)
	caster:FindAbilityByName("bvo_ichigo_skill_4"):SetLevel(level2)
	caster:FindAbilityByName("bvo_ichigo_skill_4_off"):SetHidden(true)

	local level3 = caster:FindAbilityByName("bvo_ichigo_skill_5_off"):GetLevel()
	caster:SwapAbilities("bvo_ichigo_skill_5", "bvo_ichigo_skill_5_off", true, true)
	caster:FindAbilityByName("bvo_ichigo_skill_5"):SetLevel(level3)
...
function ichigo_skill_3_end(keys)
	...
	local off_sync1 = caster:FindAbilityByName("bvo_ichigo_skill_4"):GetCooldownTimeRemaining()
	local off_sync2 = caster:FindAbilityByName("bvo_ichigo_skill_5"):GetCooldownTimeRemaining()

	local level2 = caster:FindAbilityByName("bvo_ichigo_skill_4"):GetLevel()
	caster:SwapAbilities("bvo_ichigo_skill_4", "bvo_ichigo_skill_4_off", true, true)
	caster:FindAbilityByName("bvo_ichigo_skill_4_off"):SetLevel(level2)
	caster:FindAbilityByName("bvo_ichigo_skill_4"):SetHidden(true)

	local level3 = caster:FindAbilityByName("bvo_ichigo_skill_5"):GetLevel()
	caster:SwapAbilities("bvo_ichigo_skill_5", "bvo_ichigo_skill_5_off", true, true)
	caster:FindAbilityByName("bvo_ichigo_skill_5_off"):SetLevel(level3)
	caster:FindAbilityByName("bvo_ichigo_skill_5"):SetHidden(true)

	caster:FindAbilityByName("bvo_ichigo_skill_4_off"):StartCooldown(off_sync1)
	caster:FindAbilityByName("bvo_ichigo_skill_5_off"):StartCooldown(off_sync2)
...
function ichigo_skill_5_cero_damage(keys)
	...
	local damageTable = {
		victim = target,
		attacker = caster,
		damage = ( caster:GetStrength() * 10 ) + damage,
		damage_type = DAMAGE_TYPE_MAGICAL,
	}
...
function ichigo_skill_5_getsuga(keys)
	...
	local damageTable = {
		victim = target,
		attacker = caster,
		damage = ( caster:GetStrength() * 20 ) + damage,
		damage_type = DAMAGE_TYPE_MAGICAL,
	}
