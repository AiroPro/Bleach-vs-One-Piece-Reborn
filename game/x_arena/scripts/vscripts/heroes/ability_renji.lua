...
function bvo_renji_skill_1_damage(keys)
	...
	local damageTable = {
		victim = target,
		attacker = caster,
		damage = multi * caster:GetStrength() + damage,
...
function bvo_renji_skill_3(keys)
	...
	--
	local sync3 = caster:FindAbilityByName("bvo_renji_skill_1"):GetCooldownTimeRemaining()

	local level3 = caster:FindAbilityByName("bvo_renji_skill_1"):GetLevel()
	caster:SwapAbilities("bvo_renji_skill_1_off", "bvo_renji_skill_1", true, true)
	caster:FindAbilityByName("bvo_renji_skill_1_off"):SetLevel(level3)
	caster:FindAbilityByName("bvo_renji_skill_1"):SetHidden(true)

	caster:FindAbilityByName("bvo_renji_skill_1_off"):StartCooldown(sync3)
	--
	local sync4 = caster:FindAbilityByName("bvo_renji_skill_4"):GetCooldownTimeRemaining()

	local level4 = caster:FindAbilityByName("bvo_renji_skill_4"):GetLevel()
	caster:SwapAbilities("bvo_renji_skill_4_off", "bvo_renji_skill_4", true, true)
	caster:FindAbilityByName("bvo_renji_skill_4_off"):SetLevel(level4)
	caster:FindAbilityByName("bvo_renji_skill_4"):SetHidden(true)

	caster:FindAbilityByName("bvo_renji_skill_4_off"):StartCooldown(sync4)
end
...
function bvo_renji_skill_3_damage(keys)
	...
	if not target:HasAbility("custom_point_dummy") then
		...
		local damageTable = {
			victim = target,
			attacker = caster,
			damage = ( caster:GetStrength() * str_multi + lvl_multi * caster:GetLevel() ) / 8,
			damage_type = DAMAGE_TYPE_PHYSICAL,
		}
...
function bvo_renji_skill_3_end(keys)
	...
	local sync3 = caster:FindAbilityByName("bvo_renji_skill_1_off"):GetCooldownTimeRemaining()

	local level3 = caster:FindAbilityByName("bvo_renji_skill_1_off"):GetLevel()
	caster:SwapAbilities("bvo_renji_skill_1", "bvo_renji_skill_1_off", true, true)
	caster:FindAbilityByName("bvo_renji_skill_1"):SetLevel(level3)
	caster:FindAbilityByName("bvo_renji_skill_1_off"):SetHidden(true)

	caster:FindAbilityByName("bvo_renji_skill_1"):StartCooldown(sync3)
	--
	local sync4 = caster:FindAbilityByName("bvo_renji_skill_4_off"):GetCooldownTimeRemaining()

	local level4 = caster:FindAbilityByName("bvo_renji_skill_4_off"):GetLevel()
	caster:SwapAbilities("bvo_renji_skill_4", "bvo_renji_skill_4_off", true, true)
	caster:FindAbilityByName("bvo_renji_skill_4"):SetLevel(level4)
	caster:FindAbilityByName("bvo_renji_skill_4_off"):SetHidden(true)

	caster:FindAbilityByName("bvo_renji_skill_4"):StartCooldown(sync4)
end
...
function bvo_renji_skill_4(keys)
	...
	--skill
	local sync2 = caster:FindAbilityByName("bvo_renji_skill_5_off"):GetCooldownTimeRemaining()

	local level2 = caster:FindAbilityByName("bvo_renji_skill_5_off"):GetLevel()
	caster:SwapAbilities("bvo_renji_skill_5", "bvo_renji_skill_5_off", true, true)
	caster:FindAbilityByName("bvo_renji_skill_5"):SetLevel(level2)
	caster:FindAbilityByName("bvo_renji_skill_5_off"):SetHidden(true)

	caster:FindAbilityByName("bvo_renji_skill_5"):StartCooldown(sync2)
	--
	local sync3 = caster:FindAbilityByName("bvo_renji_skill_1"):GetCooldownTimeRemaining()
	...
	caster:FindAbilityByName("bvo_renji_skill_1_off"):StartCooldown(sync3)
	--
	local sync4 = caster:FindAbilityByName("bvo_renji_skill_3"):GetCooldownTimeRemaining()

	local level4 = caster:FindAbilityByName("bvo_renji_skill_3"):GetLevel()
	caster:SwapAbilities("bvo_renji_skill_3_off", "bvo_renji_skill_3", true, true)
	caster:FindAbilityByName("bvo_renji_skill_3_off"):SetLevel(level4)
	caster:FindAbilityByName("bvo_renji_skill_3"):SetHidden(true)

	caster:FindAbilityByName("bvo_renji_skill_3_off"):StartCooldown(sync4)
end
		...
		for _,unit in pairs(localUnits) do
			...
			if not flag then
				local damageTable = {
					victim = unit,
					attacker = caster,
					damage = caster:GetStrength() * str_multi + caster:GetLevel() * lvl_multi,
					damage_type = DAMAGE_TYPE_PHYSICAL,
				}
				ApplyDamage(damageTable)
				SendOverheadEventMessage(nil, OVERHEAD_ALERT_BONUS_POISON_DAMAGE, caster, ApplyDamage(damageTable) , nil)
...
function bvo_renji_skill_4_skill( caster )
	if not caster:FindAbilityByName("bvo_renji_skill_5"):IsHidden() then
		local sync2 = caster:FindAbilityByName("bvo_renji_skill_5"):GetCooldownTimeRemaining()

		local level2 = caster:FindAbilityByName("bvo_renji_skill_5"):GetLevel()
		caster:SwapAbilities("bvo_renji_skill_5_off", "bvo_renji_skill_5", true, true)
		caster:FindAbilityByName("bvo_renji_skill_5_off"):SetLevel(level2)
		caster:FindAbilityByName("bvo_renji_skill_5"):SetHidden(true)

		caster:FindAbilityByName("bvo_renji_skill_5_off"):StartCooldown(sync2)
		--
		local sync3 = caster:FindAbilityByName("bvo_renji_skill_1_off"):GetCooldownTimeRemaining()
		...
		caster:FindAbilityByName("bvo_renji_skill_1"):StartCooldown(sync3)
		--
		local sync4 = caster:FindAbilityByName("bvo_renji_skill_3_off"):GetCooldownTimeRemaining()

		local level4 = caster:FindAbilityByName("bvo_renji_skill_3_off"):GetLevel()
		caster:SwapAbilities("bvo_renji_skill_3", "bvo_renji_skill_3_off", true, true)
		caster:FindAbilityByName("bvo_renji_skill_3"):SetLevel(level4)
		caster:FindAbilityByName("bvo_renji_skill_3_off"):SetHidden(true)

		caster:FindAbilityByName("bvo_renji_skill_3"):StartCooldown(sync4)
	end
end
...
function bvo_renji_skill_5_prodmg(keys)
	...
	local damageTable = {
		victim = target,
		attacker = caster,
		damage = multi * caster:GetStrength(),
		damage_type = DAMAGE_TYPE_PHYSICAL,
	}
