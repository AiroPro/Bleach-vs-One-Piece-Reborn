...
function bvo_rukia_skill_4(keys)
	...
	local off_sync1 = caster:FindAbilityByName("bvo_rukia_skill_5_off"):GetCooldownTimeRemaining()

	local level = caster:FindAbilityByName("bvo_rukia_skill_5_off"):GetLevel()
	caster:SwapAbilities("bvo_rukia_skill_5", "bvo_rukia_skill_5_off", true, true)
	caster:FindAbilityByName("bvo_rukia_skill_5"):SetLevel(level)
	caster:FindAbilityByName("bvo_rukia_skill_5_off"):SetHidden(true)

	caster:FindAbilityByName("bvo_rukia_skill_5"):StartCooldown(off_sync1)
end
...
function bvo_rukia_skill_4_end(keys)
	...
	local off_sync1 = caster:FindAbilityByName("bvo_rukia_skill_5"):GetCooldownTimeRemaining()

	local level = caster:FindAbilityByName("bvo_rukia_skill_5"):GetLevel()
	caster:SwapAbilities("bvo_rukia_skill_5", "bvo_rukia_skill_5_off", true, true)
	caster:FindAbilityByName("bvo_rukia_skill_5_off"):SetLevel(level)
	caster:FindAbilityByName("bvo_rukia_skill_5"):SetHidden(true)

	caster:FindAbilityByName("bvo_rukia_skill_5_off"):StartCooldown(off_sync1)
