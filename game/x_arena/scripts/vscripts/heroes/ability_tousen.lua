...
function bvo_tousen_skill_5(keys)
	...
	local sync2 = caster:FindAbilityByName("bvo_tousen_skill_4"):GetCooldownTimeRemaining()
	local sync3 = caster:FindAbilityByName("bvo_tousen_skill_1"):GetCooldownTimeRemaining()

	local level2 = caster:FindAbilityByName("bvo_tousen_skill_4"):GetLevel()
	caster:SwapAbilities("bvo_tousen_skill_4", "bvo_tousen_skill_4_off", true, true)
	caster:FindAbilityByName("bvo_tousen_skill_4_off"):SetLevel(level2)
	caster:FindAbilityByName("bvo_tousen_skill_4"):SetHidden(true)

	local level3 = caster:FindAbilityByName("bvo_tousen_skill_1"):GetLevel()
	caster:SwapAbilities("bvo_tousen_skill_1", "bvo_tousen_skill_1_off", true, true)
	caster:FindAbilityByName("bvo_tousen_skill_1_off"):SetLevel(level3)
	caster:FindAbilityByName("bvo_tousen_skill_1"):SetHidden(true)

	caster:FindAbilityByName("bvo_tousen_skill_4_off"):StartCooldown(sync2)
	caster:FindAbilityByName("bvo_tousen_skill_1_off"):StartCooldown(sync3)
end
...
function bvo_tousen_skill_5_end( event )
	...
	if ability.tether_ally ~= nil and not ability.tether_ally:IsNull() then
		...
		--end
		local sync2 = caster:FindAbilityByName("bvo_tousen_skill_4_off"):GetCooldownTimeRemaining()
		local sync3 = caster:FindAbilityByName("bvo_tousen_skill_1_off"):GetCooldownTimeRemaining()

		local level2 = caster:FindAbilityByName("bvo_tousen_skill_4_off"):GetLevel()
		caster:SwapAbilities("bvo_tousen_skill_4", "bvo_tousen_skill_4_off", true, true)
		caster:FindAbilityByName("bvo_tousen_skill_4"):SetLevel(level2)
		caster:FindAbilityByName("bvo_tousen_skill_4_off"):SetHidden(true)

		local level3 = caster:FindAbilityByName("bvo_tousen_skill_1_off"):GetLevel()
		caster:SwapAbilities("bvo_tousen_skill_1", "bvo_tousen_skill_1_off", true, true)
		caster:FindAbilityByName("bvo_tousen_skill_1"):SetLevel(level3)
		caster:FindAbilityByName("bvo_tousen_skill_1_off"):SetHidden(true)

		caster:FindAbilityByName("bvo_tousen_skill_4"):StartCooldown(sync2)
		caster:FindAbilityByName("bvo_tousen_skill_1"):StartCooldown(sync3)
	end
end