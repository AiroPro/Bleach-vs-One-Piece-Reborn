...
function bvo_zaraki_skill_4(keys)
	...
	local level = caster:FindAbilityByName("bvo_zaraki_skill_5_off"):GetLevel()
	caster:FindAbilityByName("bvo_zaraki_skill_5"):SetLevel(level)
	caster:SwapAbilities("bvo_zaraki_skill_5", "bvo_zaraki_skill_5_off", true, true)
	caster:FindAbilityByName("bvo_zaraki_skill_5_off"):SetHidden(true)
end
...
function bvo_zaraki_skill_4_dead(keys)
	...
	local sync1 = caster:FindAbilityByName("bvo_zaraki_skill_5"):GetCooldownTimeRemaining()

	local level = caster:FindAbilityByName("bvo_zaraki_skill_5"):GetLevel()
	caster:FindAbilityByName("bvo_zaraki_skill_5_off"):SetLevel(level)
	caster:SwapAbilities("bvo_zaraki_skill_5", "bvo_zaraki_skill_5_off", true, true)
	caster:FindAbilityByName("bvo_zaraki_skill_5"):SetHidden(true)

	caster:FindAbilityByName("bvo_zaraki_skill_5_off"):StartCooldown(sync1)
