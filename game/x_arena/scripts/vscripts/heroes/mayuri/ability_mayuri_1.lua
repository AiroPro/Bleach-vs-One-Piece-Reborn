...
function bvo_mayuri_skill_1(keys)
	...
	caster:SwapAbilities("bvo_mayuri_skill_1", "bvo_mayuri_skill_1_cast", true, true)
	caster:FindAbilityByName("bvo_mayuri_skill_1"):SetHidden(true)
...
function bvo_mayuri_skill_1_explode(keys)
	...
	caster:SwapAbilities("bvo_mayuri_skill_1", "bvo_mayuri_skill_1_cast", true, true)
	caster:FindAbilityByName("bvo_mayuri_skill_1_cast"):SetHidden(true)
